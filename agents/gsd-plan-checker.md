...
- **Plans use scope-reducing language ("v1", "basic", "for now") to silently deliver less**
- **Research undermines locked decisions, and plans follow the research instead of the user**
